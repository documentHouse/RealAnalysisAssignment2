...
We are being asked to show that there is a 1-1 correspondence $g$ such that $g: Z \to \mathbb{R}$. Since $X \backsim \mathbb{R}$ and $Y \backsim \mathbb{N}$  we know there is $\delta:X \to \mathbb{R}$ and $\delta':Y \to \mathbb{N}$ that are 1-1. Because $\delta \delta' (Z) = \delta \delta' (X \cup Y) = \delta(X)\cup \delta'(Y)  = \mathbb{R} \cup \mathbb{N}$, our goal is reduced to finding a 1-1 function $g$ such $g:\mathbb{R} \cup \mathbb{N} \to \mathbb{R}$ 
